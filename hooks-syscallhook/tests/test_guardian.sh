#!/bin/bash
# ==============================================================================
# Guest-side test: Guardian kernel module (syscall table variant)
# ==============================================================================
# Tests the guardian module that protects /tmp/secret via syscall table patching:
